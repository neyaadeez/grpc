...
const (
	...
	GreetService_GreetMany_FullMethodName     = "/GreetService/GreetMany"
...
func (c *greetServiceClient) GreetMany(ctx context.Context, in *GreetRequest, opts ...grpc.CallOption) (GreetService_GreetManyClient, error) {
	...
	x := &greetServiceGreetManyClient{ClientStream: stream}
...
func _GreetService_GreetMany_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(GreetServiceServer).GreetMany(m, &greetServiceGreetManyServer{ServerStream: stream})
}
